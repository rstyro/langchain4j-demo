package top.lrshuai.langchain4j.springboot.rag.controller;
...
import top.lrshuai.langchain4j.springboot.rag.service.RagAssistant;
...
public class RagController {
    ...
    public R<String> chat(@RequestBody Map<String, String> request) {
        ...
        log.info("收到问题 [memoryId={}]: {}", memoryId, message);
